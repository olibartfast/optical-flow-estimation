...
traced_model.save("raft_small_traced_torchscript.pt")
print("Traced TorchScript model saved as 'raft_small_traced_torchscript.pt'")

# Method 2: Export to TorchScript using scripting (if scripting is compatible)
print("Exporting to TorchScript (Scripting)...")
try:
    scripted_model = torch.jit.script(model)
    scripted_model.save("raft_small_scripted_torchscript.pt")
    print("Scripted TorchScript model saved as 'raft_small_scripted_torchscript.pt'")
